...
set (GenerateProductVersionCurrentDir ${CMAKE_CURRENT_LIST_DIR}/version)
...
function(generate_product_version outfiles)
    ...
    set (_VersionInfoFile ${GenerateProductVersionCurrentDir}/VersionInfo.h)
    set (_VersionResourceFile ${GenerateProductVersionCurrentDir}/VersionResource.rc)
    configure_file(
